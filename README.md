...
Ajouter le fragment à votre page Liferay.

Configurer le nombre d’onglets et les options selon vos besoins.
...
Les utilisateurs finaux verront l’accordion fonctionnel avec l’onglet actif persistant si persistSelectedTab est activé.
